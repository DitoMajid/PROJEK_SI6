							...
							<div class="col-sm-5">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>
											<div class="input-group">
												<input type="text" class="form-control" required autocomplete="off" name="anggota_id" id="search-box" placeholder="Contoh ID Member : AG001" type="text" value="">
									...
									<tr>
										...
										<td>:</td>
										<td>
											<input type="number" required placeholder="Lama Pinjam Contoh : 1 Hari (1)" name="lama" class="form-control">
										</td>
									</tr>
								</table>
							</div>
							<div class="col-sm-7">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>
											<div class="input-group">
												<input type="text" class="form-control" autocomplete="off" name="buku_id" id="buku-search" placeholder="Contoh ID Produk : 2389ws02a" type="text" value="">
												<span class="input-group-btn">
