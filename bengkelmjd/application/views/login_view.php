...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/bengkel.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: White;">Sistem Informasi <br/><b>BENGKEL MJD</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:10px solid #808080;">
  ...
  <br/>
  <footer>
    <div class="login-box-body text-center bg-grey">
       <a style="color: Black;"> Copyright &copy; BENGKEL MJD - <?php echo date("Y");?>
