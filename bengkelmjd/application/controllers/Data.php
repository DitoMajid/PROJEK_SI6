...
class Data extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->data['title_web'] = 'Data Produk';
	...
	public function bukudetail()
	{
		...
		if($count > 0)
		{
			...
			echo '<script>alert("PRODUK TIDAK DITEMUKAN");window.location="'.base_url('data').'"</script>';
		}

		$this->data['title_web'] = 'Data Produk Detail';
        $this->load->view('header_view',$this->data);
        $this->load->view('sidebar_view',$this->data);
	...
	public function bukuedit()
	{
		...
		$this->data['title_web'] = 'Data Produk Edit';
        $this->load->view('header_view',$this->data);
        $this->load->view('sidebar_view',$this->data);
	...
	public function bukutambah()
	{
        ...
        $this->data['title_web'] = 'Tambah Produk';
        $this->load->view('header_view',$this->data);
        $this->load->view('sidebar_view',$this->data);
	...
	public function rak()
	{
        ...
        $this->data['title_web'] = 'Data Storage ';
        $this->load->view('header_view',$this->data);
        $this->load->view('sidebar_view',$this->data);
